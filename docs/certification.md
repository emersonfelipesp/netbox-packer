...
`netbox-packer` is prepared for the NetBox Plugin Certification Program as a
NetBox plugin for Packer template cataloging and HCP Packer Registry sync.
...
| Compatibility | NetBox `4.5.8` through `4.7.0`, including official `v4.7.0` GA at `5f06007e4c9bacc93ce17c1e645fc1143d60df3d` |
...
| Support | GitHub Issues in `emersonfelipesp/netbox-packer` |
