...
| NetBox compatibility | Plugin config declares the backward-compatible `4.5.8`–`4.7.0` range, including official `v4.7.0` GA |
...
- Certification target release: `0.0.5.post1`
